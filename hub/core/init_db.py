...
"""))
        ...
        await conn.execute(text("CREATE INDEX IF NOT EXISTS ix_user_credentials_user_id ON user_credentials (user_id)"))
        await conn.execute(text("CREATE INDEX IF NOT EXISTS ix_user_credentials_platform ON user_credentials (platform)"))
        await conn.execute(text("CREATE UNIQUE INDEX IF NOT EXISTS ix_user_credentials_user_platform ON user_credentials (user_id, platform)"))
